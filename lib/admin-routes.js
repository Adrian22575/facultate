export const ADMIN_ROUTE_GROUPS = [
  {
    ...
    routes: [
      ...
      { id: "linkedin", path: "/admin/continut/linkedin", label: "Distribuire LinkedIn", description: "Coadă generală pentru postări, aprobări și distribuire editorială.", icon: "send", kind: "linkedin" },
