...
function buildPdfExtractionInstructions({
  ...
  return [
    ...
    examType === "licenta"
      ? "Pentru licenta, daca o intrebare este partial incompleta, cu raspuns corect neclar sau cu o varianta lipsa, pastreaz-o pentru review daca intrebarea si majoritatea variantelor sunt identificabile."
      : "",
    examType === "licenta"
      ? "Pentru aceste intrebari de licenta, completeaza review_note cu prefixul `ATENTIE:` si spune concret ce trebuie completat manual."
      : "",
    examType === "licenta"
    ...
    examType === "licenta"
      ? "Sari peste intrebare doar daca lipsesc prea multe informatii ca utilizatorul sa o poata repara in review."
      : "Sari peste intrebare doar daca raspunsul corect nu poate fi identificat sau daca lipsesc prea multe variante.",
    ...
    input: [
      {
        ...
        content: [
          {
            type: "input_text",
            text: `${instructions}\n\nReturneaza doar intrebarile care apar deja in PDF, cu variantele si raspunsul corect.${rangeText} Daca pastrezi o intrebare care merita verificata atent, completeaza review_note cu motivul scurt.`
          },
          {
            type: "input_file",
