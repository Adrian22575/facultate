...
export { dateInBucharest, hourInBucharest, isAutomationDue, weekdayInBucharest } from "./automation-schedule.js";
...
const DEFAULTS = {
  dictionary: { workflow: "dictionary", enabled: true, frequency_days: 1, weekly_day: null, scheduled_hour: 10, model: "gpt-5.4", notify_telegram: true, last_scheduled_for: null },
  editorial: { workflow: "editorial", enabled: true, frequency_days: 7, weekly_day: null, scheduled_hour: 10, model: "gpt-5.4", notify_telegram: true, last_scheduled_for: null }
};
