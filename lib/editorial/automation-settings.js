...
export const AUTOMATION_MODELS = ["gpt-5.4", "gpt-5.4-mini"];

const DEFAULTS = {
  dictionary: { workflow: "dictionary", enabled: true, frequency_days: 1, model: "gpt-5.4", notify_telegram: true, last_scheduled_for: null },
  editorial: { workflow: "editorial", enabled: true, frequency_days: 7, model: "gpt-5.4", notify_telegram: true, last_scheduled_for: null }
};
