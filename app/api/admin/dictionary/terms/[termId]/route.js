...
export async function PATCH(request, { params }) {
  ...
  const { data: existing, error: existingError } = await admin.from("dictionary_terms").select("status, slug, related_term_candidates, seo_title, meta_description, search_intent, sources_needed, quality_notes").eq("id", termId).maybeSingle();
